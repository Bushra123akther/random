...
def present_data() :
    print (30*"=")
    print ("**Bursha's Kid Shop**".center(30))
    print (30*"=")
    print ("_Available Items in Store Room_".center(30))
    print (30*"=")
    for x in item_dict:
...
while True:
    ...
    print("Type '1' : Receive Items in Store")
    print("Type '2' : Calculate and Show Item")
